...
import { saveMatch, toFlip7Match } from '@/lib/repo';
...
/** Placar de uma partida de Flip 7 (rodadas somadas até a meta). */
export function Flip7MatchView({ match: m }: { match: MatchRecord }) {
